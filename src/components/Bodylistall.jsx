  ...
  useEffect(() => {
    let a = setTimeout(() => {
      axios
        ...
        .then((response) => {
          setX({ ...x, total: response?.data?.meta?.pagination?.total });
    ...
    <>
      <div className="relative z-40">
        ...
        >
          ...
          <button onClick={Add} className="w-full border-indigo-400">
            ADD DATA
          </button>
              ...
              <div key={index}>
                <Card
                  ...
                  actions={[
                    ...
                    <div
                      onClick={() => {
                        setDeleteItem(index); //setactive tại đó bằng giá trị index của mảng data và render lại
                      }}
                    >
      ...
      >
        ...
        >
          <Button
            ...
            htmlType="submit"
            style={{
              background: "linear-gradient(to right, #508acf, #a4c0d5)",
              width: "200px",
              fontSize: "20px",
            }}
          >
